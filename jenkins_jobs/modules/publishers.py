...
def sonar(parser, xml_parent, data):
    ...
    :arg str installation-name: the name of the Sonar instance to use (optional)
    ...
    :arg bool private-maven-repo: If true, use private Maven repository.
      (default false)
    :arg str maven-installation-name: name of the Maven installation to use (optional)
    ...
    if 'maven-installation-name' in data:
         XML.SubElement(sonar, 'mavenInstallationName').text = data['maven-installation-name']
    if 'jdk' in data:
